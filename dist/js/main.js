...
"use strict";
eval("\n\n__webpack_require__(/*! ./scss/main.scss */ \"./src/scss/main.scss\");\n\n__webpack_require__(/*! ./tabs */ \"./src/tabs.js\");\n\n__webpack_require__(/*! ./js/insta_api/index */ \"./src/js/insta_api/index.js\");\n\n__webpack_require__(/*! ./js/blog_api/index */ \"./src/js/blog_api/index.js\");\n\n__webpack_require__(/*! ./js/poesia_api/index */ \"./src/js/poesia_api/index.js\");\n\n__webpack_require__(/*! ./js/livros_api/index */ \"./src/js/livros_api/index.js\");\n\n//# sourceURL=webpack:///./src/index.js?");

/***/ }),

/***/ "./src/js/blog_api/config.js":
/*!***********************************!*\
  !*** ./src/js/blog_api/config.js ***!
  \***********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n//Create a config like this:\n\nvar proxy = exports.proxy = \"\";\nvar url = exports.url = \"http://www.eupassarinho.org/\";\nvar count = exports.count = 100;\nvar element_id = exports.element_id = \"blog\";\nvar path = exports.path = \"blog\";\nvar params = exports.params = \"\";\nvar post_type = exports.post_type = \"posts\";\nvar resPerPage = exports.resPerPage = 6;\n\n//# sourceURL=webpack:///./src/js/blog_api/config.js?");

/***/ }),

/***/ "./src/js/blog_api/index.js":
/*!**********************************!*\
  !*** ./src/js/blog_api/index.js ***!
  \**********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _config = __webpack_require__(/*! ./../config */ \"./src/js/blog_api/config.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Search = function () {\n  function Search(query) {\n    _classCallCheck(this, Search);\n\n    this.query = query;\n  }\n\n  _createClass(Search, [{\n    key: \"getResults\",\n    value: function () {\n      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var res;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                _context.prev = 0;\n                res = \"\";\n\n                if (!(_config.path === \"insta\")) {\n                  _context.next = 8;\n                  break;\n                }\n\n                _context.next = 5;\n                return (0, _axios2.default)(\"\" + _config.proxy + _config.url + _config.path + \"?access_token=\" + _config.token + \"&count=\" + _config.count);\n\n              case 5:\n                res = _context.sent;\n                _context.next = 11;\n                break;\n\n              case 8:\n                _context.next = 10;\n                return (0, _axios2.default)(\"\" + _config.proxy + _config.url + _config.path + \"/wp-json/wp/v2/\" + _config.post_type + \"?search=\" + this.query + \"&per_page\" + _config.count + \"&\" + _config.params);\n\n              case 10:\n                res = _context.sent;\n\n              case 11:\n                this.result = res.data;\n                // console.log(this.result);\n                _context.next = 17;\n                break;\n\n              case 14:\n                _context.prev = 14;\n                _context.t0 = _context[\"catch\"](0);\n\n                alert(_context.t0);\n\n              case 17:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this, [[0, 14]]);\n      }));\n\n      function getResults() {\n        return _ref.apply(this, arguments);\n      }\n\n      return getResults;\n    }()\n  }]);\n\n  return Search;\n}();\n\nexports.default = Search;\n\n//# sourceURL=webpack:///./src/js/blog_api/models/Search.js?");

/***/ }),

/***/ "./src/js/blog_api/views/base.js":
/*!***************************************!*\
  !*** ./src/js/blog_api/views/base.js ***!
  \***************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.clearLoader = exports.renderLoader = exports.elementStrings = exports.elements = undefined;\n\nvar _config = __webpack_require__(/*! ./../config */ \"./src/js/blog_api/config.js\");\n\nvar elements = exports.elements = {\n    searchForm: document.getElementById(_config.element_id).getElementsByClassName(\"search\")[0],\n    searchInput: document.getElementById(_config.element_id).getElementsByClassName(\"search__field\")[0],\n    searchRes: document.getElementById(_config.element_id).getElementsByClassName('results')[0],\n    searchResList: document.getElementById(_config.element_id).getElementsByClassName(\"results__list\")[0],\n    searchResPages: document.getElementById(_config.element_id).getElementsByClassName(\"results__pages\")[0]\n};\nconsole.log(elements);\nvar elementStrings = exports.elementStrings = {\n    loader: 'loader'\n};\n\nvar renderLoader = exports.renderLoader = function renderLoader(parent) {\n    var loader = \"\\n        <div class=\\\"\" + elementStrings.loader + \"\\\">\\n            <svg>\\n                <use href=\\\"/src/img/icons.svg#icon-cw\\\"></use>\\n            </svg>\\n        </div>\\n    \";\n    parent.insertAdjacentHTML('afterbegin', loader);\n};\n\nvar clearLoader = exports.clearLoader = function clearLoader() {\n    var loader = document.querySelector(\".\" + elementStrings.loader);\n    if (loader) loader.parentElement.removeChild(loader);\n};\n\n//# sourceURL=webpack:///./src/js/blog_api/views/base.js?");

/***/ }),

/***/ "./src/js/blog_api/views/searchView.js":
/*!*********************************************!*\
  !*** ./src/js/blog_api/views/searchView.js ***!
  \*********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n//Create a config like this:\n\nvar proxy = exports.proxy = \"\";\nvar url = exports.url = \"https://api.instagram.com/v1/users/self/media/recent/\";\nvar count = exports.count = 100;\nvar element_id = exports.element_id = \"insta\";\nvar resPerPage = exports.resPerPage = 6;\nvar path = exports.path = \"\";\nvar token = exports.token = \"1004315668.d1f16c0.35e1f6c70f9b4227a90b85eee83ee54b\";\n\n//# sourceURL=webpack:///./src/js/insta_api/config.js?");

/***/ }),

/***/ "./src/js/insta_api/index.js":
/*!***********************************!*\
  !*** ./src/js/insta_api/index.js ***!
  \***********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.controlSearch = undefined;\n\nvar _Search = __webpack_require__(/*! ./models/Search */ \"./src/js/insta_api/models/Search.js\");\n\nvar _Search2 = _interopRequireDefault(_Search);\n\nvar _searchView = __webpack_require__(/*! ./views/searchView */ \"./src/js/insta_api/views/searchView.js\");\n\nvar searchView = _interopRequireWildcard(_searchView);\n\nvar _base = __webpack_require__(/*! ./views/base */ \"./src/js/insta_api/views/base.js\");\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\n/** Global state of App //\r\n- Search objetct\r\n*/\n\nvar state = {};\n\nvar controlSearch = exports.controlSearch = function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n    var query;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            // 1) Get query from view\n            query = searchView.getInput();\n\n            // Novo objeto de busca\n\n            state.search = new _Search2.default(query);\n\n            // Prepara a UI para os resultados\n            searchView.clearInput();\n            searchView.clearResults();\n            (0, _base.renderLoader)(_base.elements.searchRes);\n\n            // BUsca os posts\n\n            // 4) Search for recipes\n            _context.next = 7;\n            return state.search.getResults();\n\n          case 7:\n\n            // 5) Render results on UI\n            (0, _base.clearLoader)();\n            searchView.renderResults(state.search.result);\n\n          case 9:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, undefined);\n  }));\n\n  return function controlSearch() {\n    return _ref.apply(this, arguments);\n  };\n}();\n\ncontrolSearch();\n_base.elements.searchForm.addEventListener('submit', function (e) {\n  e.preventDefault();\n  controlSearch();\n});\n\n_base.elements.searchResPages.addEventListener('click', function (e) {\n  var btn = e.target.closest('.btn-inline');\n  if (btn) {\n    var goToPage = parseInt(btn.dataset.goto, 10);\n    searchView.clearResults();\n    searchView.renderResults(state.search.result, goToPage);\n  }\n});\n\n//# sourceURL=webpack:///./src/js/insta_api/index.js?");

/***/ }),

/***/ "./src/js/insta_api/models/Search.js":
/*!*******************************************!*\
  !*** ./src/js/insta_api/models/Search.js ***!
  \*******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _config = __webpack_require__(/*! ./../config */ \"./src/js/insta_api/config.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Search = function () {\n  function Search(query) {\n    _classCallCheck(this, Search);\n\n    this.query = query;\n  }\n\n  _createClass(Search, [{\n    key: \"getResults\",\n    value: function () {\n      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var res;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                _context.prev = 0;\n                res = \"\";\n\n                if (!(_config.element_id === \"insta\")) {\n                  _context.next = 8;\n                  break;\n                }\n\n                _context.next = 5;\n                return (0, _axios2.default)(\"\" + _config.proxy + _config.url + _config.path + \"?access_token=\" + _config.token + \"&count=\" + _config.count);\n\n              case 5:\n                res = _context.sent;\n                _context.next = 11;\n                break;\n\n              case 8:\n                _context.next = 10;\n                return (0, _axios2.default)(\"\" + _config.proxy + _config.url + _config.path + \"/wp-json/wp/v2/\" + _config.post_type + \"?search=\" + this.query + \"&per_page\" + _config.count + \"&\" + _config.params);\n\n              case 10:\n                res = _context.sent;\n\n              case 11:\n                this.result = res.data;\n                // console.log(this.result);\n                _context.next = 17;\n                break;\n\n              case 14:\n                _context.prev = 14;\n                _context.t0 = _context[\"catch\"](0);\n\n                alert(_context.t0);\n\n              case 17:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this, [[0, 14]]);\n      }));\n\n      function getResults() {\n        return _ref.apply(this, arguments);\n      }\n\n      return getResults;\n    }()\n  }]);\n\n  return Search;\n}();\n\nexports.default = Search;\n\n//# sourceURL=webpack:///./src/js/insta_api/models/Search.js?");

/***/ }),

/***/ "./src/js/insta_api/views/base.js":
/*!****************************************!*\
  !*** ./src/js/insta_api/views/base.js ***!
  \****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.clearLoader = exports.renderLoader = exports.elementStrings = exports.elements = undefined;\n\nvar _config = __webpack_require__(/*! ./../config */ \"./src/js/insta_api/config.js\");\n\nvar elements = exports.elements = {\n    searchForm: document.getElementById(_config.element_id).getElementsByClassName(\"search\")[0],\n    searchInput: document.getElementById(_config.element_id).getElementsByClassName(\"search__field\")[0],\n    searchRes: document.getElementById(_config.element_id).getElementsByClassName('results')[0],\n    searchResList: document.getElementById(_config.element_id).getElementsByClassName(\"results__list\")[0],\n    searchResPages: document.getElementById(_config.element_id).getElementsByClassName(\"results__pages\")[0]\n};\nconsole.log(elements);\nvar elementStrings = exports.elementStrings = {\n    loader: 'loader'\n};\n\nvar renderLoader = exports.renderLoader = function renderLoader(parent) {\n    var loader = \"\\n        <div class=\\\"\" + elementStrings.loader + \"\\\">\\n            <svg>\\n                <use href=\\\"/src/img/icons.svg#icon-cw\\\"></use>\\n            </svg>\\n        </div>\\n    \";\n    parent.insertAdjacentHTML('afterbegin', loader);\n};\n\nvar clearLoader = exports.clearLoader = function clearLoader() {\n    var loader = document.querySelector(\".\" + elementStrings.loader);\n    if (loader) loader.parentElement.removeChild(loader);\n};\n\n//# sourceURL=webpack:///./src/js/insta_api/views/base.js?");

/***/ }),

/***/ "./src/js/insta_api/views/searchView.js":
/*!**********************************************!*\
  !*** ./src/js/insta_api/views/searchView.js ***!
  \**********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.renderResults = exports.renderPost = exports.clearResults = exports.clearInput = exports.getInput = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/insta_api/views/base.js\");\n\nvar _config = __webpack_require__(/*! ./../config */ \"./src/js/insta_api/config.js\");\n\nvar getInput = exports.getInput = function getInput() {\n  return _base.elements.searchInput.value;\n}; // retorna o valor inserido no campo de busca//\n\n// elementos da UI\nvar clearInput = exports.clearInput = function clearInput() {\n  _base.elements.searchInput.value = \"\";\n  _base.elements.searchResPages.value = \"\";\n};\n\nvar clearResults = exports.clearResults = function clearResults() {\n  _base.elements.searchResList.innerHTML = \"\";\n  _base.elements.searchResPages.innerHTML = \"\";\n  console.log(_base.elements);\n};\n\nvar renderPost = exports.renderPost = function renderPost(post) {\n  var markup = void 0;\n  if (_config.element_id === \"insta\") {\n    markup = \"\\n            <div class=\\\"card\\\">\\n                <a class=\\\"results__link card-img-top\\\" target=\\\"_blank\\\" href=\\\"\" + post.link + \"\\\">\\n                    <figure class=\\\"results__fig\\\">\\n                        <img src=\\\"\" + post.images.standard_resolution.url + \"\\\" title=\\\"\" + post.caption.text + \"\\\" alt=\\\"\" + post.caption.text + \"\\\" class=\\\"img-responsive\\\">\\n                    </figure>\\n                </a>\\n                <div class=\\\"card-body\\\">\\n                    <p class=\\\"results__caption card-text\\\">\" + post.caption.text.substring(0, post.caption.text.substring(0, 144).lastIndexOf(\" \")) + \" (...) <a class=\\\"results__link\\\" target=\\\"_blank\\\" href=\\\"\" + post.link + \"\\\">Leia tudo</a></p>\\n                </div>\\n            </div>\\n    \";\n  } else {\n    markup = \"\\n      <div class=\\\"card\\\">\\n          <a class=\\\"results__link card-img-top\\\" href=\\\"\" + post.guid.rendered + \"\\\">\\n              <img src=\\\"\" + (!post.better_featured_image ? \"/src/img/logo.png\" : post.better_featured_image.source_url) + \"?resize=300%2C200\\\" alt=\\\"\" + post.title.rendered + \"\\\" class=\\\"img-responsive\\\">\\n          </a>\\n          <div class=\\\"card-body\\\">\\n              <h4 class=\\\"card-title results__name\\\">\" + post.title.rendered + \"</h4>\\n              <p class=\\\"card-text\\\">\" + post.excerpt.rendered + \"</p>\\n          </div>\\n      </div>\\n      \";\n  }\n  _base.elements.searchResList.insertAdjacentHTML(\"beforeend\", markup);\n};\n\n// type: 'prev' or 'next'\nvar createButton = function createButton(page, type) {\n  return \"\\n    <button class=\\\"btn-inline results__btn--\" + type + \"\\\" data-goto=\" + (type === \"prev\" ? page - 1 : page + 1) + \">\\n        <span>P\\xE1gina \" + (type === \"prev\" ? page - 1 : page + 1) + \"</span>\\n        <svg class=\\\"search__icon\\\">\\n            <use href=\\\"img/icons.svg#icon-triangle-\" + (type === \"prev\" ? \"left\" : \"right\") + \"\\\"></use>\\n        </svg>\\n    </button>\\n\";\n};\n\nvar renderButtons = function renderButtons(page, numResults, resPerPage) {\n  var pages = Math.ceil(numResults / resPerPage);\n\n  var button = void 0;\n  if (page === 1 && pages > 1) {\n    // Only button to go to next page\n    button = createButton(page, \"next\");\n  } else if (page < pages) {\n    // Both buttons\n    button = \"\\n            \" + createButton(page, \"prev\") + \"\\n            \" + createButton(page, \"next\") + \"\\n        \";\n  } else if (page === pages && pages > 1) {\n    // Only button to go to prev page\n    button = createButton(page, \"prev\");\n  }\n\n  _base.elements.searchResPages.insertAdjacentHTML(\"afterbegin\", button);\n};\n\nvar renderResults = exports.renderResults = function renderResults(posts) {\n  var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;\n  var resPerPage = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _config.resPerPage;\n\n  // renderiza resultado da página\n  var start = (page - 1) * resPerPage;\n  var end = page * resPerPage;\n  console.log(posts);\n  if (_config.element_id === \"insta\") {\n    posts.data.slice(start, end).forEach(renderPost);\n  } else {\n    posts.slice(start, end).forEach(renderPost);\n  }\n  // render pagination buttons\n  renderButtons(page, posts.length, resPerPage);\n};\n\n//# sourceURL=webpack:///./src/js/insta_api/views/searchView.js?");

/***/ }),

/***/ "./src/js/livros_api/config.js":
/*!*************************************!*\
  !*** ./src/js/livros_api/config.js ***!
  \*************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n//Create a config like this:\n\nvar proxy = exports.proxy = \"\";\nvar url = exports.url = \"http://www.eupassarinho.org/\";\nvar count = exports.count = 100;\nvar element_id = exports.element_id = \"livros\";\nvar path = exports.path = \"blog\";\nvar params = exports.params = \"?parent=3738\";\nvar post_type = exports.post_type = \"pages\";\nvar resPerPage = exports.resPerPage = 6;\n\n//# sourceURL=webpack:///./src/js/livros_api/config.js?");

/***/ }),

/***/ "./src/js/livros_api/index.js":
/*!************************************!*\
  !*** ./src/js/livros_api/index.js ***!
  \************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.controlSearch = undefined;\n\nvar _Search = __webpack_require__(/*! ./models/Search */ \"./src/js/livros_api/models/Search.js\");\n\nvar _Search2 = _interopRequireDefault(_Search);\n\nvar _searchView = __webpack_require__(/*! ./views/searchView */ \"./src/js/livros_api/views/searchView.js\");\n\nvar searchView = _interopRequireWildcard(_searchView);\n\nvar _base = __webpack_require__(/*! ./views/base */ \"./src/js/livros_api/views/base.js\");\n\nvar _config = __webpack_require__(/*! ./config */ \"./src/js/livros_api/config.js\");\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\n/** Global state of App //\r\n- Search objetct\r\n*/\n\nvar state = {};\n\nvar controlSearch = exports.controlSearch = function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n    var query;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            // 1) Get query from view\n            query = searchView.getInput();\n\n            // Novo objeto de busca\n\n            state.search = new _Search2.default(query);\n\n            // Prepara a UI para os resultados\n            searchView.clearInput();\n            searchView.clearResults();\n            (0, _base.renderLoader)(_base.elements.searchRes);\n\n            // BUsca os posts\n\n            // 4) Search for recipes\n            _context.next = 7;\n            return state.search.getResults();\n\n          case 7:\n\n            // 5) Render results on UI\n            (0, _base.clearLoader)();\n            searchView.renderResults(state.search.result);\n\n          case 9:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, undefined);\n  }));\n\n  return function controlSearch() {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nif (_base.elements.searchForm) {\n  alert(\"LIVROS diz \" + _base.elements.searchForm.innerHTML);\n  controlSearch();\n  _base.elements.searchForm.addEventListener(\"submit\", function (e) {\n    e.preventDefault();\n    controlSearch();\n  });\n  _base.elements.searchResPages.addEventListener(\"click\", function (e) {\n    var btn = e.target.closest(\".btn-inline\");\n    if (btn) {\n      var goToPage = parseInt(btn.dataset.goto, 10);\n      searchView.clearResults();\n      searchView.renderResults(state.search.result, goToPage);\n    }\n  });\n} else {\n  alert(_base.elements.searchForm);\n}\n\n//# sourceURL=webpack:///./src/js/livros_api/index.js?");

/***/ }),

/***/ "./src/js/livros_api/models/Search.js":
/*!********************************************!*\
  !*** ./src/js/livros_api/models/Search.js ***!
  \********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _config = __webpack_require__(/*! ./../config */ \"./src/js/livros_api/config.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Search = function () {\n  function Search(query) {\n    _classCallCheck(this, Search);\n\n    this.query = query;\n  }\n\n  _createClass(Search, [{\n    key: \"getResults\",\n    value: function () {\n      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var res;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                _context.prev = 0;\n                res = \"\";\n\n                if (!(_config.path === \"insta\")) {\n                  _context.next = 8;\n                  break;\n                }\n\n                _context.next = 5;\n                return (0, _axios2.default)(\"\" + _config.proxy + _config.url + _config.path + \"?access_token=\" + _config.token + \"&count=\" + _config.count);\n\n              case 5:\n                res = _context.sent;\n                _context.next = 11;\n                break;\n\n              case 8:\n                _context.next = 10;\n                return (0, _axios2.default)(\"\" + _config.proxy + _config.url + _config.path + \"/wp-json/wp/v2/\" + _config.post_type + \"?search=\" + this.query + \"&per_page\" + _config.count + \"&\" + _config.params);\n\n              case 10:\n                res = _context.sent;\n\n              case 11:\n                this.result = res.data;\n                // console.log(this.result);\n                _context.next = 17;\n                break;\n\n              case 14:\n                _context.prev = 14;\n                _context.t0 = _context[\"catch\"](0);\n\n                alert(_context.t0);\n\n              case 17:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this, [[0, 14]]);\n      }));\n\n      function getResults() {\n        return _ref.apply(this, arguments);\n      }\n\n      return getResults;\n    }()\n  }]);\n\n  return Search;\n}();\n\nexports.default = Search;\n\n//# sourceURL=webpack:///./src/js/livros_api/models/Search.js?");

/***/ }),

/***/ "./src/js/livros_api/views/base.js":
/*!*****************************************!*\
  !*** ./src/js/livros_api/views/base.js ***!
  \*****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.clearLoader = exports.renderLoader = exports.elementStrings = exports.elements = undefined;\n\nvar _config = __webpack_require__(/*! ./../config */ \"./src/js/livros_api/config.js\");\n\nvar elements = exports.elements = {\n    searchForm: document.getElementById(_config.element_id).getElementsByClassName(\"search\")[0],\n    searchInput: document.getElementById(_config.element_id).getElementsByClassName(\"search__field\")[0],\n    searchRes: document.getElementById(_config.element_id).getElementsByClassName('results')[0],\n    searchResList: document.getElementById(_config.element_id).getElementsByClassName(\"results__list\")[0],\n    searchResPages: document.getElementById(_config.element_id).getElementsByClassName(\"results__pages\")[0]\n};\nconsole.log(elements);\nvar elementStrings = exports.elementStrings = {\n    loader: 'loader'\n};\n\nvar renderLoader = exports.renderLoader = function renderLoader(parent) {\n    var loader = \"\\n        <div class=\\\"\" + elementStrings.loader + \"\\\">\\n            <svg>\\n                <use href=\\\"/src/img/icons.svg#icon-cw\\\"></use>\\n            </svg>\\n        </div>\\n    \";\n    parent.insertAdjacentHTML('afterbegin', loader);\n};\n\nvar clearLoader = exports.clearLoader = function clearLoader() {\n    var loader = document.querySelector(\".\" + elementStrings.loader);\n    if (loader) loader.parentElement.removeChild(loader);\n};\n\n//# sourceURL=webpack:///./src/js/livros_api/views/base.js?");

/***/ }),

/***/ "./src/js/livros_api/views/searchView.js":
/*!***********************************************!*\
  !*** ./src/js/livros_api/views/searchView.js ***!
  \***********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.renderResults = exports.renderPost = exports.clearResults = exports.clearInput = exports.getInput = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/livros_api/views/base.js\");\n\nvar _config = __webpack_require__(/*! ./../config */ \"./src/js/livros_api/config.js\");\n\nvar getInput = exports.getInput = function getInput() {\n  return _base.elements.searchInput.value;\n}; // retorna o valor inserido no campo de busca//\n\n// elementos da UI\nvar clearInput = exports.clearInput = function clearInput() {\n  _base.elements.searchInput.value = \"\";\n  _base.elements.searchResPages.value = \"\";\n};\n\nvar clearResults = exports.clearResults = function clearResults() {\n  _base.elements.searchResList.innerHTML = \"\";\n  _base.elements.searchResPages.innerHTML = \"\";\n  console.log(_base.elements);\n};\n\nvar renderPost = exports.renderPost = function renderPost(post) {\n  var markup = void 0;\n  if (_config.element_id === \"insta\") {\n    markup = \"\\n            <div class=\\\"card\\\">\\n                <a class=\\\"results__link card-img-top\\\" target=\\\"_blank\\\" href=\\\"\" + post.link + \"\\\">\\n                    <figure class=\\\"results__fig\\\">\\n                        <img src=\\\"\" + post.images.standard_resolution.url + \"\\\" title=\\\"\" + post.caption.text + \"\\\" alt=\\\"\" + post.caption.text + \"\\\" class=\\\"img-responsive\\\">\\n                    </figure>\\n                </a>\\n                <div class=\\\"card-body\\\">\\n                    <p class=\\\"results__caption card-text\\\">\" + post.caption.text.substring(0, post.caption.text.substring(0, 144).lastIndexOf(\" \")) + \" (...) <a class=\\\"results__link\\\" target=\\\"_blank\\\" href=\\\"\" + post.link + \"\\\">Leia tudo</a></p>\\n                </div>\\n            </div>\\n    \";\n  } else {\n    markup = \"\\n      <div class=\\\"card\\\">\\n          <a class=\\\"results__link card-img-top\\\" href=\\\"\" + post.guid.rendered + \"\\\">\\n              <img src=\\\"\" + (!post.better_featured_image ? \"/src/img/logo.png\" : post.better_featured_image.source_url) + \"?resize=300%2C200\\\" alt=\\\"\" + post.title.rendered + \"\\\" class=\\\"img-responsive\\\">\\n          </a>\\n          <div class=\\\"card-body\\\">\\n              <h4 class=\\\"card-title results__name\\\">\" + post.title.rendered + \"</h4>\\n              <p class=\\\"card-text\\\">\" + post.excerpt.rendered + \"</p>\\n          </div>\\n      </div>\\n      \";\n  }\n  _base.elements.searchResList.insertAdjacentHTML(\"beforeend\", markup);\n};\n\n// type: 'prev' or 'next'\nvar createButton = function createButton(page, type) {\n  return \"\\n    <button class=\\\"btn-inline results__btn--\" + type + \"\\\" data-goto=\" + (type === \"prev\" ? page - 1 : page + 1) + \">\\n        <span>P\\xE1gina \" + (type === \"prev\" ? page - 1 : page + 1) + \"</span>\\n        <svg class=\\\"search__icon\\\">\\n            <use href=\\\"img/icons.svg#icon-triangle-\" + (type === \"prev\" ? \"left\" : \"right\") + \"\\\"></use>\\n        </svg>\\n    </button>\\n\";\n};\n\nvar renderButtons = function renderButtons(page, numResults, resPerPage) {\n  var pages = Math.ceil(numResults / resPerPage);\n\n  var button = void 0;\n  if (page === 1 && pages > 1) {\n    // Only button to go to next page\n    button = createButton(page, \"next\");\n  } else if (page < pages) {\n    // Both buttons\n    button = \"\\n            \" + createButton(page, \"prev\") + \"\\n            \" + createButton(page, \"next\") + \"\\n        \";\n  } else if (page === pages && pages > 1) {\n    // Only button to go to prev page\n    button = createButton(page, \"prev\");\n  }\n\n  _base.elements.searchResPages.insertAdjacentHTML(\"afterbegin\", button);\n};\n\nvar renderResults = exports.renderResults = function renderResults(posts) {\n  var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;\n  var resPerPage = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _config.resPerPage;\n\n  // renderiza resultado da página\n  var start = (page - 1) * resPerPage;\n  var end = page * resPerPage;\n  console.log(posts);\n  if (_config.element_id === \"insta\") {\n    posts.data.slice(start, end).forEach(renderPost);\n  } else {\n    posts.slice(start, end).forEach(renderPost);\n  }\n\n  // render pagination buttons\n  renderButtons(page, posts.length, resPerPage);\n};\n\n//# sourceURL=webpack:///./src/js/livros_api/views/searchView.js?");

/***/ }),

/***/ "./src/js/poesia_api/config.js":
/*!*************************************!*\
  !*** ./src/js/poesia_api/config.js ***!
  \*************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n//Create a config like this:\n\nvar proxy = exports.proxy = \"\";\nvar url = exports.url = \"http://www.eupassarinho.org/\";\nvar count = exports.count = 100;\nvar element_id = exports.element_id = \"poesiadeluta\";\nvar path = exports.path = \"poesiadeluta\";\nvar params = exports.params = \"\";\nvar post_type = exports.post_type = \"posts\";\nvar resPerPage = exports.resPerPage = 6;\n\n//# sourceURL=webpack:///./src/js/poesia_api/config.js?");

/***/ }),

/***/ "./src/js/poesia_api/index.js":
/*!************************************!*\
  !*** ./src/js/poesia_api/index.js ***!
  \************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.controlSearch = undefined;\n\nvar _Search = __webpack_require__(/*! ./models/Search */ \"./src/js/poesia_api/models/Search.js\");\n\nvar _Search2 = _interopRequireDefault(_Search);\n\nvar _searchView = __webpack_require__(/*! ./views/searchView */ \"./src/js/poesia_api/views/searchView.js\");\n\nvar searchView = _interopRequireWildcard(_searchView);\n\nvar _base = __webpack_require__(/*! ./views/base */ \"./src/js/poesia_api/views/base.js\");\n\nvar _config = __webpack_require__(/*! ./config */ \"./src/js/poesia_api/config.js\");\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\n/** Global state of App //\r\n- Search objetct\r\n*/\n\nvar state = {};\n\nvar controlSearch = exports.controlSearch = function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n    var query;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            // 1) Get query from view\n            query = searchView.getInput();\n\n            // Novo objeto de busca\n\n            state.search = new _Search2.default(query);\n\n            // Prepara a UI para os resultados\n            searchView.clearInput();\n            searchView.clearResults();\n            (0, _base.renderLoader)(_base.elements.searchRes);\n\n            // BUsca os posts\n\n            // 4) Search for recipes\n            _context.next = 7;\n            return state.search.getResults();\n\n          case 7:\n\n            // 5) Render results on UI\n            (0, _base.clearLoader)();\n            searchView.renderResults(state.search.result);\n\n          case 9:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, undefined);\n  }));\n\n  return function controlSearch() {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nif (_base.elements.searchForm) {\n  controlSearch();\n  _base.elements.searchForm.addEventListener(\"submit\", function (e) {\n    e.preventDefault();\n    controlSearch();\n  });\n  _base.elements.searchResPages.addEventListener(\"click\", function (e) {\n    var btn = e.target.closest(\".btn-inline\");\n    if (btn) {\n      var goToPage = parseInt(btn.dataset.goto, 10);\n      searchView.clearResults();\n      searchView.renderResults(state.search.result, goToPage);\n    }\n  });\n}\n\n//# sourceURL=webpack:///./src/js/poesia_api/index.js?");

/***/ }),

/***/ "./src/js/poesia_api/models/Search.js":
/*!********************************************!*\
  !*** ./src/js/poesia_api/models/Search.js ***!
  \********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _config = __webpack_require__(/*! ./../config */ \"./src/js/poesia_api/config.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Search = function () {\n  function Search(query) {\n    _classCallCheck(this, Search);\n\n    this.query = query;\n  }\n\n  _createClass(Search, [{\n    key: \"getResults\",\n    value: function () {\n      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var res;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                _context.prev = 0;\n                res = \"\";\n\n                if (!(_config.path === \"insta\")) {\n                  _context.next = 8;\n                  break;\n                }\n\n                _context.next = 5;\n                return (0, _axios2.default)(\"\" + _config.proxy + _config.url + _config.path + \"?access_token=\" + _config.token + \"&count=\" + _config.count);\n\n              case 5:\n                res = _context.sent;\n                _context.next = 11;\n                break;\n\n              case 8:\n                _context.next = 10;\n                return (0, _axios2.default)(\"\" + _config.proxy + _config.url + _config.path + \"/wp-json/wp/v2/\" + _config.post_type + \"?search=\" + this.query + \"&per_page\" + _config.count + \"&\" + _config.params);\n\n              case 10:\n                res = _context.sent;\n\n              case 11:\n                this.result = res.data;\n                // console.log(this.result);\n                _context.next = 17;\n                break;\n\n              case 14:\n                _context.prev = 14;\n                _context.t0 = _context[\"catch\"](0);\n\n                alert(_context.t0);\n\n              case 17:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this, [[0, 14]]);\n      }));\n\n      function getResults() {\n        return _ref.apply(this, arguments);\n      }\n\n      return getResults;\n    }()\n  }]);\n\n  return Search;\n}();\n\nexports.default = Search;\n\n//# sourceURL=webpack:///./src/js/poesia_api/models/Search.js?");

/***/ }),

/***/ "./src/js/poesia_api/views/base.js":
/*!*****************************************!*\
  !*** ./src/js/poesia_api/views/base.js ***!
  \*****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.clearLoader = exports.renderLoader = exports.elementStrings = exports.elements = undefined;\n\nvar _config = __webpack_require__(/*! ./../config */ \"./src/js/poesia_api/config.js\");\n\nvar elements = exports.elements = {\n    searchForm: document.getElementById(_config.element_id).getElementsByClassName(\"search\")[0],\n    searchInput: document.getElementById(_config.element_id).getElementsByClassName(\"search__field\")[0],\n    searchRes: document.getElementById(_config.element_id).getElementsByClassName('results')[0],\n    searchResList: document.getElementById(_config.element_id).getElementsByClassName(\"results__list\")[0],\n    searchResPages: document.getElementById(_config.element_id).getElementsByClassName(\"results__pages\")[0]\n};\nconsole.log(elements);\nvar elementStrings = exports.elementStrings = {\n    loader: 'loader'\n};\n\nvar renderLoader = exports.renderLoader = function renderLoader(parent) {\n    var loader = \"\\n        <div class=\\\"\" + elementStrings.loader + \"\\\">\\n            <svg>\\n                <use href=\\\"/src/img/icons.svg#icon-cw\\\"></use>\\n            </svg>\\n        </div>\\n    \";\n    parent.insertAdjacentHTML('afterbegin', loader);\n};\n\nvar clearLoader = exports.clearLoader = function clearLoader() {\n    var loader = document.querySelector(\".\" + elementStrings.loader);\n    if (loader) loader.parentElement.removeChild(loader);\n};\n\n//# sourceURL=webpack:///./src/js/poesia_api/views/base.js?");

/***/ }),

/***/ "./src/js/poesia_api/views/searchView.js":
/*!***********************************************!*\
  !*** ./src/js/poesia_api/views/searchView.js ***!
  \***********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.renderResults = exports.renderPost = exports.clearResults = exports.clearInput = exports.getInput = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/poesia_api/views/base.js\");\n\nvar _config = __webpack_require__(/*! ./../config */ \"./src/js/poesia_api/config.js\");\n\nvar getInput = exports.getInput = function getInput() {\n  return _base.elements.searchInput.value;\n}; // retorna o valor inserido no campo de busca//\n\n// elementos da UI\nvar clearInput = exports.clearInput = function clearInput() {\n  _base.elements.searchInput.value = \"\";\n  _base.elements.searchResPages.value = \"\";\n};\n\nvar clearResults = exports.clearResults = function clearResults() {\n  _base.elements.searchResList.innerHTML = \"\";\n  _base.elements.searchResPages.innerHTML = \"\";\n  console.log(_base.elements);\n};\n\nvar renderPost = exports.renderPost = function renderPost(post) {\n  var markup = void 0;\n  if (_config.element_id === \"insta\") {\n    markup = \"\\n            <div class=\\\"card\\\">\\n                <a class=\\\"results__link card-img-top\\\" target=\\\"_blank\\\" href=\\\"\" + post.link + \"\\\">\\n                    <figure class=\\\"results__fig\\\">\\n                        <img src=\\\"\" + post.images.standard_resolution.url + \"\\\" title=\\\"\" + post.caption.text + \"\\\" alt=\\\"\" + post.caption.text + \"\\\" class=\\\"img-responsive\\\">\\n                    </figure>\\n                </a>\\n                <div class=\\\"card-body\\\">\\n                    <p class=\\\"results__caption card-text\\\">\" + post.caption.text.substring(0, post.caption.text.substring(0, 144).lastIndexOf(\" \")) + \" (...) <a class=\\\"results__link\\\" target=\\\"_blank\\\" href=\\\"\" + post.link + \"\\\">Leia tudo</a></p>\\n                </div>\\n            </div>\\n    \";\n  } else {\n    markup = \"\\n      <div class=\\\"card\\\">\\n          <a class=\\\"results__link card-img-top\\\" href=\\\"\" + post.guid.rendered + \"\\\">\\n              <img src=\\\"\" + (!post.better_featured_image ? \"/src/img/logo.png\" : post.better_featured_image.source_url) + \"?resize=300%2C200\\\" alt=\\\"\" + post.title.rendered + \"\\\" class=\\\"img-responsive\\\">\\n          </a>\\n          <div class=\\\"card-body\\\">\\n              <h4 class=\\\"card-title results__name\\\">\" + post.title.rendered + \"</h4>\\n              <p class=\\\"card-text\\\">\" + post.excerpt.rendered + \"</p>\\n          </div>\\n      </div>\\n      \";\n  }\n  _base.elements.searchResList.insertAdjacentHTML(\"beforeend\", markup);\n};\n\n// type: 'prev' or 'next'\nvar createButton = function createButton(page, type) {\n  return \"\\n    <button class=\\\"btn-inline results__btn--\" + type + \"\\\" data-goto=\" + (type === \"prev\" ? page - 1 : page + 1) + \">\\n        <span>P\\xE1gina \" + (type === \"prev\" ? page - 1 : page + 1) + \"</span>\\n        <svg class=\\\"search__icon\\\">\\n            <use href=\\\"img/icons.svg#icon-triangle-\" + (type === \"prev\" ? \"left\" : \"right\") + \"\\\"></use>\\n        </svg>\\n    </button>\\n\";\n};\n\nvar renderButtons = function renderButtons(page, numResults, resPerPage) {\n  var pages = Math.ceil(numResults / resPerPage);\n\n  var button = void 0;\n  if (page === 1 && pages > 1) {\n    // Only button to go to next page\n    button = createButton(page, \"next\");\n  } else if (page < pages) {\n    // Both buttons\n    button = \"\\n            \" + createButton(page, \"prev\") + \"\\n            \" + createButton(page, \"next\") + \"\\n        \";\n  } else if (page === pages && pages > 1) {\n    // Only button to go to prev page\n    button = createButton(page, \"prev\");\n  }\n\n  _base.elements.searchResPages.insertAdjacentHTML(\"afterbegin\", button);\n};\n\nvar renderResults = exports.renderResults = function renderResults(posts) {\n  var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;\n  var resPerPage = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _config.resPerPage;\n\n  // renderiza resultado da página\n  var start = (page - 1) * resPerPage;\n  var end = page * resPerPage;\n  console.log(posts);\n  if (_config.element_id === \"insta\") {\n    posts.data.slice(start, end).forEach(renderPost);\n  } else {\n    posts.slice(start, end).forEach(renderPost);\n  }\n\n  // render pagination buttons\n  renderButtons(page, posts.length, resPerPage);\n};\n\n//# sourceURL=webpack:///./src/js/poesia_api/views/searchView.js?");
